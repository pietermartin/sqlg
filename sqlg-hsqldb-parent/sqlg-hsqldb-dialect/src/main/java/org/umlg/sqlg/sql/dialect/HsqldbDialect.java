...
public class HsqldbDialect extends BaseSqlDialect implements SqlBulkDialect {
    ...
    public List<String> sqlgTopologyCreationScripts() {
        ...
        result.add("CREATE TABLE IF NOT EXISTS \"sqlg_schema\".\"V_graph\" (\"ID\" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"createdOn\" TIMESTAMP WITH TIME ZONE, \"updatedOn\" TIMESTAMP WITH TIME ZONE, \"version\" LONGVARCHAR, \"dbVersion\" LONGVARCHAR);");
        ...
        result.add("CREATE TABLE IF NOT EXISTS \"sqlg_schema\".\"V_property\" (" +
                ...
                "\"name\" LONGVARCHAR, " +
                "\"type\" LONGVARCHAR, " +
                "\"index_type\" LONGVARCHAR DEFAULT 'NONE');");
