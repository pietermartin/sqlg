...
public class HsqldbDialect extends BaseSqlDialect {
    ...
    public List<String> sqlgTopologyCreationScripts() {
        ...
        result.add("CREATE TABLE \"sqlg_schema\".\"V_unique_constraint\" (\"ID\"  BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"createdOn\" TIMESTAMP WITH TIME ZONE, \"name\" LONGVARCHAR, \"onVertices\" BOOLEAN);");
        ...
        result.add("CREATE TABLE \"sqlg_schema\".\"E_vertex_unique_constraint\"(\"ID\" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, \"sqlg_schema.unique_constraint__I\" BIGINT, \"sqlg_schema.vertex__O\" BIGINT, FOREIGN KEY (\"sqlg_schema.unique_constraint__I\") REFERENCES \"sqlg_schema\".\"V_unique_constraint\" (\"ID\"),  FOREIGN KEY (\"sqlg_schema.vertex__O\") REFERENCES \"sqlg_schema\".\"V_vertex\" (\"ID\"));");
        return result;
    }
