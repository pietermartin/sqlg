...
//            Vertex person = this.sqlG.addVertex(T.label, "Schema1.Person", "name", "a");
//            Vertex car = this.sqlG.addVertex(T.label, "Schema2.Car", "name", "b");
//            Vertex car2 = this.sqlG.addVertex(T.label, "Schema2.Car", "name", "b", "surname", "e");
//            Vertex bike = this.sqlG.addVertex(T.label, "Schema2.Bike", "name", "c");
//            this.sqlG.tx().commit();
//        } catch (Exception e) {
...
//        //check that the SchemaCache is clear
//        Assert.assertFalse(this.sqlG.getSchemaManager().tableExist("Schema2", SchemaManager.VERTEX_PREFIX + "Car"));
//    }
//
//    @Test
