...
//        this.sqlgGraph.tx().commit();
//
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1).repeat(__.out("ab").out("bc")).times(1).toList();
...
//        b1.addEdge("bc", c1);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1.id()).emit().repeat(__.out("ab", "bc")).times(2).path().toList();
...
//        this.sqlgGraph.tx().commit();
//
//        List<Path> paths = this.sqlgGraph.traversal().V(a1).emit().repeat(__.out("ab", "bc", "cd")).times(3).path().toList();
...
//        this.sqlgGraph.tx().commit();
//
//        List<Path> paths = this.sqlgGraph.traversal().V(a1).emit().repeat(__.out("ab", "bc", "cd")).times(4).path().toList();
//        Assert.assertEquals(14, paths.size());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a1)));
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a1)));
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 2 && p.get(0).equals(a1) && p.get(1).equals(b1)));
...
//        this.sqlgGraph.tx().commit();
//
//        List<Path> paths = this.sqlgGraph.traversal().V(a1).repeat(__.out("ab", "bc", "cd")).emit().times(3).path().toList();
...
//        this.sqlgGraph.tx().commit();
//
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1).repeat(__.out("ab", "bc", "cd")).emit().times(3).toList();
...
//        this.sqlgGraph.tx().commit();
//
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1).times(3).repeat(__.out("ab", "bc", "cd")).emit().toList();
...
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(marko, josh, lop).repeat(__.out()).times(2).emit().path().toList();
//
...
//        this.sqlgGraph.tx().commit();
//
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1, a2, a3).repeat(__.out("knows")).times(2).emit().toList();
//        Assert.assertEquals(3, vertices.size());
...
//
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2, a3).repeat(__.out("knows")).emit().times(2).path().toList();
...
//        this.sqlgGraph.tx().commit();
//
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1, a2, a3).emit().repeat(__.out("knows")).times(2).toList();
...
//        Assert.assertEquals(0, vertices.size());
//
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2, a3).emit().repeat(__.out("knows")).times(2).path().toList();
...
//        a2.addEdge("ab", b1);
//        this.sqlgGraph.tx().commit();
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1, a2).emit().repeat(__.out("ab")).times(1).toList();
//        Assert.assertEquals(4, vertices.size());
//    }
//
//    @Test
...
//        b1.addEdge("ba", a2);
//        this.sqlgGraph.tx().commit();
//        List<Vertex> vertices = this.sqlgGraph.traversal().V(a1, a2).emit().repeat(__.out("ab", "ba")).times(2).toList();
//        Assert.assertEquals(4, vertices.size());
//    }
//
//    @Test
...
//        b1.addEdge("ba", a2);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2).emit().repeat(__.out("ab", "ba")).times(3).path().toList();
//        Assert.assertEquals(4, paths.size());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a1)));
//        paths.remove(paths.stream().filter(p -> p.size() == 1 && p.get(0).equals(a1)).findAny().get());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a2)));
...
//        b1.addEdge("ba", a2);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2, b1).emit().repeat(__.out("ab", "ba")).times(2).path().toList();
//
//        Assert.assertEquals(6, paths.size());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a1)));
//        paths.remove(paths.stream().filter(p -> p.size() == 1 && p.get(0).equals(a1)).findAny().get());
...
//        b1.addEdge("ba", a2);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2, b1).repeat(__.out("ab", "ba")).emit().times(2).path().toList();
//
//        Assert.assertEquals(3, paths.size());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 2 && p.get(0).equals(a1) && p.get(1).equals(b1)));
//        paths.remove(paths.stream().filter(p -> p.size() == 2 && p.get(0).equals(a1) && p.get(1).equals(b1)).findAny().get());
...
//        a1.addEdge("ab", b1);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, b1).emit().times(2).repeat(__.out()).path().toList();
//
//        Assert.assertEquals(3, paths.size());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a1)));
//        paths.remove(paths.stream().filter(p -> p.size() == 1 && p.get(0).equals(a1)).findAny().get());
...
//        a2.addEdge("ba", b1);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2).repeat(__.out()).emit().times(2).path().toList();
//        Assert.assertEquals(3, paths.size());
...
//        this.sqlgGraph.tx().commit();
//
//        List<Path> paths = this.sqlgGraph.traversal().V(a1).repeat(__.out()).emit().times(2).path().toList();
...
//        c1.addEdge("cd", d1);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2).times(3).repeat(__.out()).path().toList();
//
...
//        b1.addEdge("bc", c1);
//        this.sqlgGraph.tx().commit();
//        List<Path> paths = this.sqlgGraph.traversal().V(b1).emit().times(2).repeat(__.out()).path().toList();
//        Assert.assertEquals(2, paths.size());
//        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(b1)));
//        paths.remove(paths.stream().filter(p -> p.size() == 1 && p.get(0).equals(b1)).findAny().get());
...
//    }
    ...
    public void testEmitTimes2MultiplePaths() {
        ...
        List<Path> paths = this.sqlgGraph.traversal().V(a1, a2, b1).emit().times(2).repeat(__.out()).path().toList();
        Assert.assertEquals(6, paths.size());
        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 1 && p.get(0).equals(a1)));
        paths.remove(paths.stream().filter(p -> p.size() == 1 && p.get(0).equals(a1)).findAny().get());
        Assert.assertTrue(paths.stream().anyMatch(p -> p.size() == 2 && p.get(0).equals(a1) && p.get(1).equals(a2)));
