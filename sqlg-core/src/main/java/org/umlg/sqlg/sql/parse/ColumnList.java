...
public class ColumnList {
	 ...
	 * @param alias
	 */
	public void add(String schema, String table, String column, String alias) {
		Column c=new Column(schema, table, column);
		columns.put(c, alias);
	}
	...
	public void add(SchemaTableTree stt, String column, String alias) {
		add(stt.getSchemaTable(),column,alias);
	}
	 ...
	 * @param alias
	 */
	public void add(SchemaTable st, String column, String alias) {
		add(st.getSchema(),st.getTable(),column,alias);
	}
	 ...
	 * @return
	 */
	public String getAlias(String schema, String table, String column){
		Column c=new Column(schema, table, column);
	...
	public String getAlias(SchemaTableTree stt, String column){
		return getAlias(stt.getSchemaTable(),column);
	}
	 ...
	 * @return
	 */
	public String getAlias(SchemaTable st, String column){
		return getAlias(st.getSchema(),st.getTable(),column);
	}
