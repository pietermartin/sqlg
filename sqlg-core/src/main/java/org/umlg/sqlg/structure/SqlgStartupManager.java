    ...
    private void extractProperty(String schema, String table, String columnName, Integer columnType, String typeName, Map<String, PropertyDefinition> columns, ListIterator<Triple<String, Integer, String>> metaDataIter) {
        ...
        if (metaDataIter.hasNext()) {
            ...
            if (column2Name.startsWith(columnName + "~~~")) {
                ...
                } else if ((column2Type == Types.ARRAY && this.sqlDialect.internalSqlArrayTypeNameToPropertyType(typeName2, column2Name, metaDataIter) == PropertyType.STRING_ARRAY)) {
                    ...
                    if (metaDataIter.hasNext()) {
                        ...
                        if (column3Name.startsWith(columnName + "~~~")) {
                            if (column3Type == Types.ARRAY) {
                                Preconditions.checkState(sqlDialect.internalSqlArrayTypeNameToPropertyType(typeName3, column3Name, metaDataIter) == PropertyType.INTEGER_ARRAY, "Only Period have a third column and it must be a Integer");
                            ...
                            if (column2Type == Types.ARRAY) {
                                Preconditions.checkState(sqlDialect.internalSqlArrayTypeNameToPropertyType(typeName2, column2Name, metaDataIter) == PropertyType.INTEGER_ARRAY, "Only Period have a third column and it must be a Integer");
        ...
        if (propertyDefinition == null) {
            propertyDefinition = PropertyDefinition.of(this.sqlDialect.internalSqlTypeToPropertyType(this.sqlgGraph, schema, table, columnName, columnType, typeName, metaDataIter));
        }
