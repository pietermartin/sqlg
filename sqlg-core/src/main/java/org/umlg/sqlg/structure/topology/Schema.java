...
public class Schema implements TopologyInf {
    ...
    void renameEdgeLabel(EdgeLabel edgeLabel, String label) {
        ...
        outVertexLabels.forEach(AbstractLabel::markDirty);
        inVertexLabels.forEach(AbstractLabel::markDirty);
    ...
    public EdgeLabel ensureEdgeLabelExist(
        ...
        if (edgeLabelOptional.isEmpty()) {
            ...
            if (edgeLabelOptional.isEmpty()) {
                ...
                edgeLabel.markDirty();
                outVertexLabel.markDirty();
                inVertexLabel.markDirty();
                markDirty();
