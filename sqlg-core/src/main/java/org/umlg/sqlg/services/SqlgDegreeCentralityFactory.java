...
/**
 * Count the IN/OUT/BOTH edges for a set of vertices. Demonstrates a {@link Type#Streaming} service.
 */
public class SqlgDegreeCentralityFactory extends SqlgServiceRegistry.SqlgServiceFactory<Vertex,Long> implements Service<Vertex, Long> {

    public static final String NAME = "sqlg.degree.centrality";
    ...
    public SqlgDegreeCentralityFactory(final SqlgGraph graph) {
        super(graph, NAME);
    }
