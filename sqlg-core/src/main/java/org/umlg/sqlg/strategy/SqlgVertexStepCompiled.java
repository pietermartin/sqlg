...
public class SqlgVertexStepCompiled<S extends SqlgElement, E extends SqlgElement> extends FlatMapStep<S, E> {
    ...
    private Iterator<Pair<E, Multimap<String, Pair<E, Optional<Long>>>>> iterator = EmptyIterator.instance();
    ...
    protected Traverser<E> processNextStart() {
        while (true) {
            if (this.iterator.hasNext()) {
                ...
                Pair<E, Multimap<String, Pair<E, Optional<Long>>>> next = this.iterator.next();
                E e = next.getLeft();
                Multimap<String, Pair<E, Optional<Long>>> labeledObjects = next.getRight();
    ...
    protected Iterator<Pair<E, Multimap<String, Pair<E, Optional<Long>>>>> flatMapCustom(Traverser.Admin<S> traverser) {
