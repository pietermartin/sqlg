...
//
//
//    void combineSteps_old(Traversal.Admin<?, ?> traversal, List<Step> steps, ListIterator<Step<?, ?>> stepIterator) {
...
//                    ReplacedStep replacedStep = ReplacedStep.from(
//                            lastReplacedStep,
//                            ((SqlgGraph) traversal.getGraph().get()).getTopology(),
//                            (AbstractStep) step,
//                            pathCount
//                    );
//
