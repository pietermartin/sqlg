...
.Postgresql
pieter@pieter-Precision-7510:~/Downloads/tinkerpop-console/apache-tinkerpop-gremlin-console-3.6.4-bin/apache-tinkerpop-gremlin-console-3.6.4/bin/$ ./gremlin.sh
[subs="specialchars, attributes"]
