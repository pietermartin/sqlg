...
Consecutive GraphStep, VertexStep, EdgeVertexStep, EdgeOtherVertexStep, HasStep, RepeatStep, OrderGlobalStep,
RangeGlobalStep, ChooseStep, OptionalStep and DropStep are currently combined.
