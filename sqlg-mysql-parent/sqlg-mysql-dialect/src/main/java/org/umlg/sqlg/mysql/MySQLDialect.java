...
public class MySQLDialect extends BaseSqlDialect {
    ...
    public String getAutoIncrementPrimaryKeyConstruct() {
        return "BIGINT AUTO_INCREMENT NOT NULL PRIMARY KEY";
    }
    ...
    public String existIndexQuery(SchemaTable schemaTable, String prefix, String indexName) {
        StringBuilder sb = new StringBuilder("SELECT * FROM information_schema.statistics WHERE table_schema = '");
    ...
    public List<String> sqlgTopologyCreationScripts() {
        ...
        result.add("CREATE TABLE `sqlg_schema`.`V_property` (`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `createdOn` DATETIME, `name` VARCHAR(255), `type` VARCHAR(255));");
        result.add("CREATE TABLE `sqlg_schema`.`V_index` (`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `createdOn` DATETIME, `name` VARCHAR(255), `index_type` VARCHAR(255));");
        result.add("CREATE TABLE `sqlg_schema`.`V_globalUniqueIndex` (" +
                "`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, " +
                "`createdOn` DATETIME, " +
                "`name` VARCHAR(255));");

        result.add("CREATE TABLE `sqlg_schema`.`E_schema_vertex`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.vertex__I` BIGINT, `sqlg_schema.schema__O` BIGINT, FOREIGN KEY (`sqlg_schema.vertex__I`) REFERENCES `sqlg_schema`.`V_vertex` (`ID`),  FOREIGN KEY (`sqlg_schema.schema__O`) REFERENCES `sqlg_schema`.`V_schema` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_in_edges`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.edge__I` BIGINT, `sqlg_schema.vertex__O` BIGINT, FOREIGN KEY (`sqlg_schema.edge__I`) REFERENCES `sqlg_schema`.`V_edge` (`ID`),  FOREIGN KEY (`sqlg_schema.vertex__O`) REFERENCES `sqlg_schema`.`V_vertex` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_out_edges`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.edge__I` BIGINT, `sqlg_schema.vertex__O` BIGINT, FOREIGN KEY (`sqlg_schema.edge__I`) REFERENCES `sqlg_schema`.`V_edge` (`ID`),  FOREIGN KEY (`sqlg_schema.vertex__O`) REFERENCES `sqlg_schema`.`V_vertex` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_vertex_property`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.property__I` BIGINT, `sqlg_schema.vertex__O` BIGINT, FOREIGN KEY (`sqlg_schema.property__I`) REFERENCES `sqlg_schema`.`V_property` (`ID`),  FOREIGN KEY (`sqlg_schema.vertex__O`) REFERENCES `sqlg_schema`.`V_vertex` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_edge_property`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.property__I` BIGINT, `sqlg_schema.edge__O` BIGINT, FOREIGN KEY (`sqlg_schema.property__I`) REFERENCES `sqlg_schema`.`V_property` (`ID`),  FOREIGN KEY (`sqlg_schema.edge__O`) REFERENCES `sqlg_schema`.`V_edge` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_vertex_index`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.index__I` BIGINT, `sqlg_schema.vertex__O` BIGINT, FOREIGN KEY (`sqlg_schema.index__I`) REFERENCES `sqlg_schema`.`V_index` (`ID`), FOREIGN KEY (`sqlg_schema.vertex__O`) REFERENCES `sqlg_schema`.`V_vertex` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_edge_index`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.index__I` BIGINT, `sqlg_schema.edge__O` BIGINT, FOREIGN KEY (`sqlg_schema.index__I`) REFERENCES `sqlg_schema`.`V_index` (`ID`), FOREIGN KEY (`sqlg_schema.edge__O`) REFERENCES `sqlg_schema`.`V_edge` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`E_index_property`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.property__I` BIGINT, `sqlg_schema.index__O` BIGINT, FOREIGN KEY (`sqlg_schema.property__I`) REFERENCES `sqlg_schema`.`V_property` (`ID`), FOREIGN KEY (`sqlg_schema.index__O`) REFERENCES `sqlg_schema`.`V_index` (`ID`));");
        result.add("CREATE TABLE `sqlg_schema`.`V_log` (`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `timestamp` DATETIME, `pid` INTEGER, `log` VARCHAR(255));");
        result.add("CREATE TABLE `sqlg_schema`.`E_globalUniqueIndex_property`(`ID` BIGINT AUTO_INCREMENT PRIMARY KEY, `sqlg_schema.property__I` BIGINT, `sqlg_schema.globalUniqueIndex__O` BIGINT, FOREIGN KEY (`sqlg_schema.property__I`) REFERENCES `sqlg_schema`.`V_property` (`ID`), FOREIGN KEY (`sqlg_schema.globalUniqueIndex__O`) REFERENCES `sqlg_schema`.`V_globalUniqueIndex` (`ID`));");
        return result;
    }
    ...
    public String getRangeClause(Range<Long> r) {
        return "LIMIT " + r.getMinimum() + "," + (r.getMaximum() - r.getMinimum());
    }
