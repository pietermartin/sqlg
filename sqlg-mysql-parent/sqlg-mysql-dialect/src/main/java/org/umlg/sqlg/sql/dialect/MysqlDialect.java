...
//    }
    ...
    /**
     * Hardcoded the rows to return. Mysql does nto support just an offset.
    ...
    public void grantReadOnlyUserPrivilegesToSqlgSchemas(SqlgGraph sqlgGraph) {
        ...
        try (Statement statement = conn.createStatement()) {
            statement.execute("CREATE USER 'sqlgReadOnly'@'localhost'");
            statement.execute("GRANT SELECT ON *.* TO 'sqlgReadOnly'@'localhost'");
