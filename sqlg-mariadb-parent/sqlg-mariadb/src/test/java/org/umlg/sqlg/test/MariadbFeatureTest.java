...
@CucumberOptions(
        ...
        objectFactory = MariadbFeatureTest.SqlgGraphGuiceFactory.class,
        features = {"classpath:/org/apache/tinkerpop/gremlin/test/features"},
        plugin = {"progress", "junit:target/cucumber.xml"})
public class MariadbFeatureTest {
...
//            "g_V_drop"
    ...
    private static Map<String, Object> getBaseConfiguration(final GraphData graphData) {
        return new HashMap<>() {{
            put("jdbc.url", "jdbc:mariadb://localhost:" + graphDataToPort(graphData) + "/?useSSL=false");
