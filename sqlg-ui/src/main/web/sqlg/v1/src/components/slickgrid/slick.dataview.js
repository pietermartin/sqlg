    ...
    function DataView(options) {
        ...
        function updateItem(id, item, columnField) {
            ...
            if (newIdxById[id] != undefined) {
                ...
                updatedItems[updatedIdxById[id]] = Object.assign(updatedItems[updatedIdxById[id]], item);
        ...
        $.extend(this, {
            ...
            "getNewItemsIdx": getNewItemsIdx,
            "getDeletedItems": getDeletedItems,
            "getUpdatedItems": getUpdatedItems,
            "clearUpdatedItems": clearUpdatedItems,
            "afterSave": afterSave,
