  ...
  function GroupItemMetadataProvider(inputOptions) {
    ...
    function defaultGroupCellFormatter(row, cell, value, columnDef, item, grid) {
      ...
      return (options.checkboxSelect ? '<span class="' + options.checkboxSelectCssClass +
          ...
          item.title +
          "</span>"  + (options.selectAll ? '<span class="groupSelectAll"> - <a href="#" class="groupSelectToggle" data-selection = true>Select All</a>' + " / " + '<a href="#" class="groupSelectToggle" data-selection = false>Deselect All</a></span>' : '');
    }
