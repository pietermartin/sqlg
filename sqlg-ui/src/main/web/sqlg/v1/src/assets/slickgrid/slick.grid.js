...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        function init() {
            ...
            // does not play well explicitInitialization
                    ...
                    if (!options.multiColumnSort) {
                        ...
                        trigger(self.onSort, {
                            ...
                            sortCols: $.map(sortColumns, function (col) {
                                return {
                                    columnId: columns[getColumnIndex(col.columnId)].id,
        ...
        function autosizeColumns(autosizeMode, isInit) {
            ...
            var i, c, colWidth, reRender, totalWidth = 0, totalWidthLessSTR = 0, strColsMinWidth = 0, totalMinWidth = 0,
    ...
    */
        ...
        function setSelectedRow(row) {
            if (!(selectionModel instanceof Slick.CellSelectionModel)) {
                throw new Error("setSelectedRow can only be called for 'Slick.CellSelectionModel'");
            }
            if (self && self.getEditorLock && !self.getEditorLock().isActive()) {
                var ranges = [];
                ranges.push(new Slick.Range(row, 0, row, 0));
